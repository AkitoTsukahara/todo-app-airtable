...
<!-- https://mdbootstrap.com/docs/standard/extended/to-do-list/#section-5 -->
          ...
          <div class="card-body p-5">
            ...
            <form class="d-flex justify-content-center align-items-center mb-4">
              <div class="form-outline flex-fill">
                <textarea type="text" id="form3" rows="2" class="form-control form-control-lg" placeholder="What do you need to do today?"/>
              </div>
            ...
            <ul class="list-group mb-0">
              <li
                ...
                <a href="#!" data-mdb-toggle="tooltip" title="Remove item">
                  <i class="fas fa-times text-primary">x</i>
                </a>
              </li>
              <li
